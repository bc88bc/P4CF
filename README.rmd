...
Given a station location, FORTRAN code *P4CF* computes source and path **P**arameters for(**4**) a **C**urved **F**ault rupture. This code has been used in PEER's NGA-West and NGA-Subduction projects (Chiou and others, 2008; Ancheta et al., 2014; Contreras et al. 2021) to calculate source and path metadata for the respective project database.

# Inputs

Inputs to _P4CF_ are entered in a DOS command, as follows: 
1. 

To terminate calculation, enter *q* as EQID.
